...
```bash
curl -fsSL https://raw.githubusercontent.com/idcsu/portflow/v1.1.1/install.sh \
  | sudo bash -s -- install --repo idcsu/portflow --version 1.1.1
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/idcsu/portflow/v1.1.1/install.sh \
  | sudo bash -s -- agent --repo idcsu/portflow --version 1.1.1 \
