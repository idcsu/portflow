...
```bash
curl -fsSL https://raw.githubusercontent.com/idcsu/portflow/v1.0.4/install.sh \
  | sudo bash -s -- install --repo idcsu/portflow --version 1.0.4
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/idcsu/portflow/v1.0.4/install.sh \
  | sudo bash -s -- agent --repo idcsu/portflow --version 1.0.4 \
